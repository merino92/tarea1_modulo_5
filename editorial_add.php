  ...
  <body>
    ...
    <?php
         if(isset($_POST["submit"])){
            ...
            $conn =conexion();
            $sql = "INSERT INTO editoriales(codigoEditorial, nombreEditorial, contacto, telefono)VALUES (?,?,?,?)";
            $consulta=$conn->prepare($sql);
            $resultado=$consulta->execute([$_POST["codigoEditorial"],$_POST["nombreEditorial"],$_POST["contacto"],$_POST["telefono"]]);
            if ($resultado) {
